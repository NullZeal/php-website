...
<html lang="en">
    <head>
        ...
        <?php 
        //Below I added the reset and global files as a constant with the define in the top of the page to show that I can also use constants to reference a file.
        ?> 
        <link rel="stylesheet" type="text/css" href="<?php echo FILE_RESET_CSS; ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo FILE_GLOBAL_CSS; ?>">
        <?php 
        //Below I added the page specific css file last with the variable taken from the function parameter
        ?> 
