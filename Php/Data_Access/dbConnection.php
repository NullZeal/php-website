...
$currentDatabaseConnection = new PDO("mysql:host=localhost;dbname=" . databaseName, dbUsername, dbPassword);

#make sure all problem thow exception (....handlers)
$currentDatabaseConnection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

#protect against some of the SQL injections
$currentDatabaseConnection->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);